...
//	 */
//	@Override
//	public ResultMessage save(Tag tag) {
//		return daoHelper.save(tag);
//	}
//
//	/**
//	 * 删除Tag
...
//		criteria.save(new Criterion<>("fileName", fileName, QueryMode.FULL));
//		criteria.save(new Criterion<>("taskPublisherId", taskId, QueryMode.FULL));
...
//		ArrayList<Criterion> criteria = new ArrayList<>();
//		criteria.save(new Criterion<>("taskWorkerId", taskWorkerId, QueryMode.FULL));
//		criteria.save(new Criterion<>("fileName", fileName, QueryMode.FULL));
//		return daoHelper.multiQuery(criteria);
//	}
//
