 ...
 * @author 巽
 **/
public interface TaskWorkerDao {
	/**
	 * 添加TaskWorker（未分配id）
	 * @param taskWorker 待添加的TaskWorker
	 * @return SUCCESS：添加成功
	 */
	ResultMessage addTaskWorker(TaskWorker taskWorker);
	/**
	 * 更新TaskWorker
	 ...
	 */
	ResultMessage updateTaskWorker(TaskWorker taskWorker);
	/**
	 * 删除TaskWorker
	 ...
	 */
	ResultMessage deleteTaskWorker(Long id);
	/**
	 ...
	 */
	List<TaskWorker> getAllTaskWorker();
